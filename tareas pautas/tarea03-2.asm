...
while:                      ; etiqueta while
    ...
    cmp ax, numero          ; comparamos si el paso A[i+1]=A[i]*2 llega al nÃºmero.
    jle multiplicacion      ; si es menor o igual, saltamos a la etiqueta multiplicaciÃ³n.
    ...
    mov antecesor, ax       ; guardamos el número del paso dado a la variable antecesor.
    jmp while               ; saltamos a la etiqueta while
...
constantes:                 ; etiqueta constantes.
    numero equ 31;17           ; constante número cuyo valor queremos buscar.
